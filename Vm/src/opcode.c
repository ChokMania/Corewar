...
/*   Updated: 2019/10/01 10:32:36 by anmauffr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (opcode == 10)
		vm->proc->wait = vm->cycle + 24;
	else if (opcode == 11)
		vm->proc->wait = vm->cycle + 24;
	else if (opcode == 12)
		vm->proc->wait = vm->cycle + 799;
	else if (opcode == 13)
		vm->proc->wait = vm->cycle + 9;
	else if (opcode == 14)
		vm->proc->wait = vm->cycle + 49;
	else if (opcode == 15)
		vm->proc->wait = vm->cycle + 999;
	else if (opcode == 16)
